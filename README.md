...
├── method_src/         # Source code related to specific methods or components (e.g., READER)
├── pretrian_model/     # Stores pre-trained model weights
├── src/                # Source code related to specific methods or components (e.g., baselines)
├── main.py             # Entry point for experiments
├── method_main.py      # Entry point for experiments
├── README.md           # This file
├── requirements.txt    # Lists Python package dependencies
└── run.sh              # Shell script for executing training and evaluation tasks
