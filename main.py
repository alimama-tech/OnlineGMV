...
from src.pretrain import run
from src.online_stream import run_stream
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='baselinemlp_oracle', help='Model name')
    parser.add_argument('--pretrain_model', type=str, default='baselinemlp', help='Pretrained Model Name')
    ...
    parser.add_argument('--learning_rate_scheduler', type=list, default=[0.99, 2], help='Learning rate scheduler')
    ...
    parser.add_argument('--train_start_day', type=float, default=0, help='Training start day') 
    parser.add_argument('--train_end_day', type=float, default=50, help='Training end day') 
